...
if result[0] == 'on':
    logging.basicConfig(filename='/home/pi/poly_auto/stop_west.log',
                        filemode='a',
...
logging.info('stop_west.py has started')
...
db_cursor.execute("UPDATE string_vars SET value='part_open' WHERE name='west_door_status'")    
db_connection.commit()

# finish up
db_connection.close()
logging.info('stop_west.py has completed')
exit()
